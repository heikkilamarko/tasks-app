...
func (m *Module) handleTaskExpiringMessage(ctx context.Context, msg shared.Message) error {
	...
	return m.EmailClient.SendEmail(ctx, m.Config.EmailToAddress, "Task Expiring", "task_expiring.html", data.Task)
}
...
func (m *Module) handleTaskExpiredMessage(ctx context.Context, msg shared.Message) error {
	...
	return m.EmailClient.SendEmail(ctx, m.Config.EmailToAddress, "Task Expired", "task_expired.html", data.Task)
}
