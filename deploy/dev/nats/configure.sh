...
sed -i "" -e "s/APP_SHARED_NATS_ACCOUNT_PUBLIC_KEY=.*/APP_SHARED_NATS_ACCOUNT_PUBLIC_KEY=$account_public_key/" "$src_dir/tasks-app.env"

sed -i "" -e "s/APP_SHARED_NATS_ACCOUNT_SEED=.*/APP_SHARED_NATS_ACCOUNT_SEED=$account_seed/" "$config_dir/tasks-app.env"
sed -i "" -e "s/APP_SHARED_NATS_ACCOUNT_SEED=.*/APP_SHARED_NATS_ACCOUNT_SEED=$account_seed/" "$src_dir/tasks-app.env"
